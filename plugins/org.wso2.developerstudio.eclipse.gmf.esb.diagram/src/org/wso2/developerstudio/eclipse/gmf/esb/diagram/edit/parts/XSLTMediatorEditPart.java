    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof XSLTMediatorImpl) {
                XSLTMediatorImpl validateMediatorDataModel = (XSLTMediatorImpl) model.getElement();
                org.apache.synapse.mediators.transform.XSLTMediator xsltMediator = null;
                try {
                    xsltMediator = XSLTMediatorTransformer
                            .createXSLTMediator((EsbNode) validateMediatorDataModel);
