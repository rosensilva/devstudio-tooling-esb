    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof FaultMediatorImpl) {
                ...
                org.apache.synapse.mediators.transform.FaultMediator faultMediator = null;
                try {
                    faultMediator = FaultMediatorTransformer
                            .createFaultMediator((FilterMediator) faultMediatorDataModel);
                ...
                } catch (URISyntaxException | JaxenException e) {
                    // ignore
                }
            }
        }
