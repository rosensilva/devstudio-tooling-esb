    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof DBReportMediatorImpl) {
                DBReportMediatorImpl DBLookupMediatorDataModel = (DBReportMediatorImpl) model.getElement();
                org.apache.synapse.mediators.db.DBReportMediator dbReportMediator = null;
                dbReportMediator = DBReportMediatorTransformer
                        .createDBReportMediator((EsbNode) DBLookupMediatorDataModel);
