...
//            if (model.getElement() instanceof RuleMediatorImpl) {
//                RuleMediatorImpl ruleMediatorDataModel = (RuleMediatorImpl) model.getElement();
//                org.apache.synapse.mediators.throttle.ThrottleMediator throttleMediator = null;
//                try {
//                    throttleMediator = ThrottleMediatorTransformer
//                            .createThrottleMediator((EsbNode) ruleMediatorDataModel, new TransformationInfo());
//
