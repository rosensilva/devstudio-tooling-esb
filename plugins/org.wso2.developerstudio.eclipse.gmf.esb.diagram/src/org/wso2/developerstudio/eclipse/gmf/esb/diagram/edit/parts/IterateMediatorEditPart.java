    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof IterateMediatorImpl) {
                IterateMediatorImpl throttleMediatorDataModel = (IterateMediatorImpl) model.getElement();
                org.apache.synapse.mediators.eip.splitter.IterateMediator iterateMediator = null;
                try {
                    iterateMediator = IterateMediatorTransformer
                            .createIterateMediator(new TransformationInfo(), (EsbNode) throttleMediatorDataModel);
