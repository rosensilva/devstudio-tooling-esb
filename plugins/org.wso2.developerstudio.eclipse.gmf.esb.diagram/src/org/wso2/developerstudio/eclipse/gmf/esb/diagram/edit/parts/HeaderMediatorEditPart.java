    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof HeaderMediatorImpl) {
                ...
                org.apache.synapse.mediators.transform.HeaderMediator headerMediator = null;
                try {
                    headerMediator = HeaderMediatorTransformer.createHeaderMediator((EsbNode) headerMediatorDataModel);
