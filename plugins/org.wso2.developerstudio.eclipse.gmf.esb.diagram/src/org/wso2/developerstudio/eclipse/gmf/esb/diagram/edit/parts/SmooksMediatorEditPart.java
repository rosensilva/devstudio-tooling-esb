    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof SmooksMediatorImpl) {
                ...
                org.wso2.carbon.mediator.transform.SmooksMediator smooksMediator = null;
                try {
                    smooksMediator = SmooksMediatorTransformer
                            .createSmooksMediator(new TransformationInfo(), (EsbNode) smooksMediatorDataModel);
