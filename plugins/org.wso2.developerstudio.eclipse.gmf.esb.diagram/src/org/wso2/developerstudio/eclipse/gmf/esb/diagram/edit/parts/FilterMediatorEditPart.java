    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof FilterMediatorImpl) {
                ...
                org.apache.synapse.mediators.filters.FilterMediator filterMediator = null;
                try {
                    filterMediator = FilterMediatorTransformer
                            .createFilterMediator((FilterMediator) filterMediatorDataModel);
