    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof XQueryMediatorImpl) {
                XQueryMediatorImpl validateMediatorDataModel = (XQueryMediatorImpl) model.getElement();
                org.apache.synapse.mediators.xquery.XQueryMediator xQueryMediator = null;
                try {
                    xQueryMediator = XQueryMediatorTransformer
                            .createXQueryMediator((EsbNode) validateMediatorDataModel);

                    XQueryMediatorSerializer xQueryMediatorSerializerSerializer = new XQueryMediatorSerializer();
                    OMElement omElement = xQueryMediatorSerializerSerializer.serializeSpecificMediator(xQueryMediator);
