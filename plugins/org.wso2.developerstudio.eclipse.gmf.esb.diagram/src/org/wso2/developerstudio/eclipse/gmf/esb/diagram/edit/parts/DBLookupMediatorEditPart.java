    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof DBLookupMediatorImpl) {
                ...
                org.apache.synapse.mediators.db.DBLookupMediator dbLookupMediator = null;
                dbLookupMediator = DBLookupMediatorTransformer
                        .createDBLookupMediator(new TransformationInfo(), (EsbNode) DBLookupMediatorDataModel);

                DBLookupMediatorSerializer validateMediatorSerializer = new DBLookupMediatorSerializer();
                OMElement omElement = validateMediatorSerializer.serializeSpecificMediator(dbLookupMediator);
