    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof BAMMediatorImpl) {
                ...
                org.wso2.carbon.mediator.bam.BamMediator bAMMediator = null;
                try {
                    bAMMediator = BAMMediatorTransformer
                            .createBAMMediator((EsbNode) bAMMediatorDataModel, new TransformationInfo());
                    ...
                    if (StringUtils
                            .isEmpty(MediatorValidationUtil.validateMediatorsFromOEMElement(omElement, "bam"))) {
