    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof EnqueueMediatorImpl) {
                ...
                org.apache.synapse.mediators.builtin.EnqueueMediator enqueueMediator = null;
                enqueueMediator = EnqueueMediatorTransformer
                        .createEnqueueMediator((EsbNode) enqueueMediatorDataModel);
