...
//                org.apache.synapse.mediators.builtin.ForEachMediator forEachMediator = null;
//                try {
//                    forEachMediator = ForEachMediatorTransformer
//                            .createForEachMediator(new TransformationInfo(), (EsbNode) forEachMediatorDataModel);
//
//                    ForEachMediatorSerializer forMediatorSerializer = new ForEachMediatorSerializer();
//                    OMElement omElement = forMediatorSerializer.serializeSpecificMediator(forEachMediator);
//
//                    if (StringUtils
