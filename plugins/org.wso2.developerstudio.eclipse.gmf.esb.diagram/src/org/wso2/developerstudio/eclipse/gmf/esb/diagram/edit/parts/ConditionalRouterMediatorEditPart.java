    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof ConditionalRouterMediatorImpl) {
                ConditionalRouterMediatorImpl propertyMediatorDataModel = (ConditionalRouterMediatorImpl) model.getElement();
                try {
                    org.apache.synapse.mediators.filters.router.ConditionalRouterMediator conditionalRouterMediator = ConditionalRouterMediatorTransformer
                            .createConditionalRouterMediator(new TransformationInfo(),(EsbNode) propertyMediatorDataModel);
                ...
                } catch ( EvaluatorException | XMLStreamException e) {
                    // ignore
                }
            }
        }
