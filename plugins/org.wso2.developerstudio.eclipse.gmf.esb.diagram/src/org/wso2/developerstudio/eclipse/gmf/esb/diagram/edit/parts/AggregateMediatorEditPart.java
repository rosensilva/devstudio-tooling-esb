    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof AggregateMediatorImpl) {
                ...
                org.apache.synapse.mediators.eip.aggregator.AggregateMediator aggregateMediator = null;
                try {
                    aggregateMediator = AggregateMediatorTransformer.createAggregateMediator(new TransformationInfo(),
                            (EsbNode) aggregateMediatorDataModel);
