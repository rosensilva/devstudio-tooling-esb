    ...
    public void notifyChanged(Notification notification) {
        if (this.getModel() instanceof CSSNodeImpl) {
            ...
            if (model.getElement() instanceof OAuthMediatorImpl) {
                ...
                org.wso2.carbon.identity.oauth.mediator.OAuthMediator oAuthMediator = null;
                oAuthMediator = OAuthMediatorTransformer
                        .createOAuthMediator((EsbNode) oAuthMediatorDataModel);
                ...
                if (StringUtils
                        .isEmpty(MediatorValidationUtil.validateMediatorsFromOEMElement(omElement, "oauthService"))) {
