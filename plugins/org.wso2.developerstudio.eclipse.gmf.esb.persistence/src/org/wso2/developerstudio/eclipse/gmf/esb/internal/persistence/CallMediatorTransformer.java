...
public class CallMediatorTransformer extends AbstractEsbNodeTransformer {
    ...
    public void transform(TransformationInfo information, EsbNode subject) throws TransformerException {
        ...
        try {
            callMediator = createCallMediator(subject, true);
    ...
    public static org.apache.synapse.mediators.builtin.CallMediator createCallMediator(EsbNode subject,
            boolean withValidation) throws TransformerException, JaxenException {
        // Check subject.
        ...
        if (visualCallMediator.getEndpointType() == CallMediatorEndpointType.XPATH) {
            ...
            Endpoint resolvingEndpoint = getEndpointFromXpath(nameSpacedProperty, withValidation);
    ...
    public static ResolvingEndpoint getEndpointFromXpath(NamespacedProperty nameSpacedProperty, boolean withValidation)
            throws JaxenException {
        SynapseXPath synapseXPath;
        ResolvingEndpoint resolvingEndpoint;
        if (StringUtils.isEmpty(nameSpacedProperty.getPropertyValue()) && withValidation) {
