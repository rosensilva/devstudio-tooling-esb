...
public class AggregateMediatorTransformer extends AbstractEsbNodeTransformer {
    ...
    public void transform(TransformationInfo information, EsbNode subject) throws TransformerException {
        ...
        try {
             ...
             */
            doTransform(information, ((AggregateMediator) subject).getOutputConnector());
    ...
    public static org.apache.synapse.mediators.eip.aggregator.AggregateMediator createAggregateMediator(
        ...
        setCommonProperties(aggregateMediator, visualAggregate);
        {
            ...
            if (StringUtils.isNotBlank(visualAggregate.getEnclosingElementProperty())) {
                aggregateMediator.setEnclosingElementPropertyName(visualAggregate.getEnclosingElementProperty());
            }
        }
